...
const Footer = () => {
  return (
    <Box sx={{ minHeight: 200, borderTop: "1px solid rgba(255, 255, 255, 0.2)", display: "flex", justifyContent: "space-around", flexDirection: { xs: "column", md: "row-reverse", overflow: "hidden" }, marginTop: 10 }}>
      <Typography>
